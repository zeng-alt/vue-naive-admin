...
export default {
  // 获取用户信息
  getUser: () => request.get('/main/v1/user/detail'),
  // 刷新token
  ...
  // 获取角色权限
  getRolePermissions: () => request.get('/main/role/permissions/tree'),
  // 验证菜单路径
  validateMenuPath: path => request.get(`/main/permission/menu/validate?path=${path}`),
}
