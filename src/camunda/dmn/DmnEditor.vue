    ...
    <n-layout has-sider sider-placement="right">
      <n-layout-content>
        <div class="dmn-wrapper" style="height: 100%; position: relative;">
          ...
          <!-- 浮动按钮组 -->
          <div class="floating-btn-group" v-show="viewType === 'drd'">
      ...
      <n-layout-sider
        ...
        bordered
      >
        <div id="properties-container" class="dmn-properties-panel" style="width: 100%; height: 99%;"></div>
      </n-layout-sider>
    </n-layout>
