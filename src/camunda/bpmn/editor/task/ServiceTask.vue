<template>
  <div style="display: flex; align-items: center;">
    <NIcon size="30">
      <span class="bpmn-icon-service-task" />
    </NIcon>
    <div style="display: flex; flex-direction: column; margin-left: 8px;">
      <span style="font-size: 12px">服务任务节点</span>
      <span>{{ name }}</span>
    </div>
  </div>
  <NTabs type="line" animated size="small">
    ...
    <NTabPane name="implementation" tab="实现者">
      <ImplementationPanel
        :bo="bo" :selected-element="selectedElement" :bpmn-modeler="bpmnModeler" :implementation-type-options="[
